...
### ▶ Current focus
**M2 · M2-T3** — `check_support` returns **all** qualifying spans, plural & ranked (brief §4; G007/G008). **M2-T1 (`verify`) and M2-T2 (`check_support`, abstention split D12) are `DONE`.**

...
### ▶ Current focus
**M2 · M2-T4** — expand the project `CLAUDE.md` runtime loop against the now-built tool contracts (`search_corpus`/`get_document`/`check_support`/`verify`). **M2-T1/T2/T3 `DONE`.**

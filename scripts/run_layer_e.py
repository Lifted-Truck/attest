...
AGENT_SYSTEM = (
    ...
    "constraint text must be a SHORT literal expected verbatim in the cited span, "
    "not a paraphrase; mark implicit ones — and locator-style ones naming the place "
    "you cite from, e.g. 'claim 9' when citing claim 9 itself — required:false) and "
    "call verify(answer, frame) before "
